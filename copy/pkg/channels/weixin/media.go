...
const (
	...
	weixinDownloadRetryDelay    = 300 * time.Millisecond // 下载重试延迟
...
func (c *WeixinChannel) storeInboundBytes(
	...
	ref, err := store.Store(tmpPath, media.MediaMeta{
		...
		Source:        "weixin",
		CleanupPolicy: media.CleanupPolicyDeleteOnCleanup, // 清理时删除
...
// SendMedia 实现 channels.MediaSender 接口，发送媒体消息
