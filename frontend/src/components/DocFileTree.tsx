...
export function DocFileTree({ agentName, refreshRev, onFileSelect, selectedDocPath }: DocFileTreeProps) {
...
function FileItem({ name, fullPath, size, paddingLeft, selected, onClick }: FileItemProps) {
  return (
    <button
      type="button"
      className={cn(
